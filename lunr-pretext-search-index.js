...
},
{
  ...
  "number": "",
  "title": "Preface",
  "body": " The following notes were written over several years of teaching graduate analysis courses at the University of Ohio. The notes are designed to cover two semesters worth of material in the field of measure theory. The notes are split into three parts. The first part introduces the basic concepts of measure and integration. Special attention is paid to the Lebesgue measure and Borel measures on the real line. The second part is an introduction to functional analysis, from a measure theoretic perspective. Here -spaces and their duals are introduced. The Riesz-Markov-Kakutani representation theorem is also covered. The notes do not serve for a full course in functional analysis. Abstract Banach spaces and Hilbert spaces are mentioned, but the focus is on specific examples: -spaces, and continuous functions on compact Hausdorff spaces. Many important functional analytic results, such as the Hahn-Banach theorem, are not covered in these notes. The third part of the notes gives further examples of measures, including product measures, Haar measure, Hausdorff measure, and probability measures. Part 1 can be covered in a single semester, parts 2 and 3 can be covered in a second semester.  There are a number of appendices. Two give some prerequisite material: prerequisites in set theory, and prerequisites in topology. There is also an appendix which gives details of some important examples of continuous functions, relevant to the current notes and the history of real analysis from which measure theory developed.  The notes owe a lot to the treatment of the topics in Royden's Real Analysis  and Folland's Real Analysis: Modern Techniques and Their Applications  . Other sources were used. Several are listed in the text at relevant times. A list is given in the References section.  The notes are written in PreTeXt . They have been made available to students online and as a pdf file. In theory, other formats can be generated from the source files if a student needs them. There are several figures in the notes. All figures are generated in SageMath. For most of the figures, the SageMath code is included in the source files, though there are a few figures for which code is not included. Some figures are interactive or animated for those viewing the html version of the notes. For the pdf version, a static image is given; for the interactive components a QR code is given which links to the interactive element.  "
},
{
  "id": "sec-intro-ftoc",
  "level": "1",
...
},
{
  ...
  "number": "2.1.1",
  "title": "",
  "body": "   -algebra    Let be a non-empty set, and let be the power set of . A collection of sets is a -algebra The suffix - is usually used to denote a countably infinite version of whatever word comes after the - . With that information you can probably infer what an algebra of sets is. if  ;  if then ;  if is a countable collection of sets in , then .   -algebra    "
},
{
  ...
  "number": "2.1.2",
  "title": "",
  "body": "   measurable space    Let be a non-empty set, and let be a -algebra of subsets of . The pair is called a measurable space . measurable space    "
},
{
...
},
{
  ...
  "number": "2.1.5",
  "title": "",
  "body": "  Let be a non-empty set. Let be a non-empty collection of sets. Then there is a unique -algebra such that , and if is a -algebra containing , then .  That is, there is a unique smallest -algebra containing .    Let be the collection of all -algebras of that contain . Note that is non-empty, as . Let That is a -algebra with the desired properties follows readily.   "
},
{
  "id": "chap-measure-space-3-10",
  "level": "2",
  "url": "chap-measure-space-3.html#chap-measure-space-3-10",
  "type": "Definition",
  "number": "2.1.6",
  "title": "",
  "body": "  Let be a non-empty set, and let be a non-empty collection of subsets of . Let be the unique, smallest -algebra containing (in the sense of ). We call the -algebra generated by . -algebra generated by a set    "
},
{
  "id": "exam-Borel-sets",
  "level": "2",
  ...
  "number": "2.1.7",
  "title": "",
  "body": "   Borel sets in     Borel sets in    Let be a topological space. Denote by the -algebra generated by the open sets in . We call the Borel sets of . Borel sets If we say that is a Borel set in X .  When , we will denote the Borel sets by .   "
},
{
...
},
{
  ...
  "number": "2.1.9",
  "title": "",
  "body": "   measures     measure space    Let be a measurable space. A function is a measure measure on if  ; and  if is a countable collection of disjoint sets in then   If is a measure on a measurable space , we call the triple a measure space . measure space The sets are called measurable sets measurable set in the measure space .   "
},
{
  "id": "chap-measure-space-3-15",
  "level": "2",
  "url": "chap-measure-space-3.html#chap-measure-space-3-15",
  "type": "Remark",
  "number": "2.1.10",
  "title": "",
...
{
  "id": "chap-measure-space-3-18",
  "level": "2",
  "url": "chap-measure-space-3.html#chap-measure-space-3-18",
  "type": "Definition",
  "number": "2.1.12",
  "title": "",
...
{
  "id": "chap-measure-space-3-19",
  "level": "2",
  "url": "chap-measure-space-3.html#chap-measure-space-3-19",
  "type": "Remark",
  "number": "2.1.13",
  "title": "",
...
{
  "id": "chap-measure-space-3-28",
  "level": "2",
  "url": "chap-measure-space-3.html#chap-measure-space-3-28",
  "type": "Definition",
  "number": "2.1.18",
  "title": "",
  "body": "  Let be a measure space. A property is said to hold for almost all almost all (abbreviated as a.a.  ) a.a. almost all or almost everywhere almost everywhere (abbreviate a.e. ) a.e. almost everywhere if there is a measurable set with such that holds on .   "
},
{
...
},
{
  ...
  "number": "2.2.1",
  "title": "",
  "body": "  Let be a measure space. Then the following hold  (Monotonicity) If with , then ; measure monotonicity   (Excision) If with and , then ; measure excision property   (Countable monotonicity) If is a countable collection of measurable sets, and is a measurable set such that , then measure countable monotonicity       Take with . Note we can write as a disjoint union Thus Thus, . If , then it follows that and . Hence, it follows from that That is finite is imporant here. Otherwise we could be looking at , which is undefined.  Now let be a countable collection of sets in . Let . Let . Continuing in this way, we let In this way, we get a countable family of disjoint measurable sets, which satisfies and for each . Thus, if we have   "
},
{
  "id": "chap-measure-space-4-4",
  "level": "2",
  "url": "chap-measure-space-4.html#chap-measure-space-4-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "the continuity of measure "
},
{
...
},
{
  ...
  "number": "2.2.3",
  "title": "",
  "body": "  Let be a measure space. Define to be the collection of subset of  For in where and with , define . Then is a -algebra and is a complete measure space. measure space completion    "
},
{
  "id": "chap-measure-space-4-9",
  "level": "2",
  "url": "chap-measure-space-4.html#chap-measure-space-4-9",
  "type": "Definition",
  "number": "2.2.4",
  "title": "",
...
},
{
  ...
  "number": "2.3.1",
  "title": "",
  "body": "   outer measure    Let be a non-empty set. A function is an outer measure outer measure on if  ;  if is a countable collection of subsets of , and then I.e. is countably monotone. countably monotone      "
},
{
  ...
  "number": "2.3.2",
  "title": "",
  "body": "  Let be a nonempty set, let be a non-empty collection of subsets of , and let be any function. Define a function by  ;  if , and there exists a countable collection of sets in such that , then   if and can not be covered by a countably infinite family in , then   Then is an outer measure on . outer measure induced     By definition, , so we only need to show that is countably monotone. Take subsets , and of with . If for some , then Suppose now that for all . Fix . For each , choose a countable collection of subsets of such that Since , the collection covers . Thus Hence , and so is countably monotone.   "
},
{
  "id": "sec-construction-8",
  "level": "2",
  "url": "sec-construction.html#sec-construction-8",
  "type": "Definition",
  "number": "2.3.3",
  "title": "",
...
},
{
  ...
  "number": "2.3.5",
  "title": "",
  "body": " Let be the collection of all open intervals in the real line. Let be the length function on , i.e. for all . Let be the outer measure induced by . Then for all intervals in ( ). The outer measure is called the Lebesgue outer measure on . outer measure Lebesgue outer measure We will see (much!) more on this later.  "
},
{
  "id": "sec-construction-13",
  "level": "2",
  "url": "sec-construction.html#sec-construction-13",
  "type": "Definition",
  "number": "2.3.6",
  "title": "",
...
},
{
  ...
  "number": "2.3.7",
  "title": "",
  "body": "  Let be a non-empty set, let be an outer measure on , and let be the collection of all subsets of which are measurable with respect to . Then is a -algebra and the restriction of to is a measure. That is, is a measure space, where . Further, is a complete measure space.    Clearly . Also, if is measurable with respect to , then is also in . To show that is a -algebra it remains to show that is closed under countable unions. We will do this in tandem with showing that is a measure.  Let and be two -measurable sets. Take any . Then, since and are measurable, we have Note that and Hence Therefore, is -measurable. It follows inductively that if is a finite collection of measurable sets, then is measurable.  Let be a finite collection of disjoint measurable sets. Take any set . Since the sets are disjoint and measurable, we have In particular, Thus far, we have shown that is closed under finite unions, and is additive on finite collections of disjoint sets in . As is closed under taking complements, it follows that is also closed under finite intersections. We need to extend finite to infinite in both instances. Let be a countable collection of measurable sets and let We will use our favorite trick to disjointize this collection. Though we have used this method before, we will go through the steps carefully to make sure that at each step we remain with a set in . Let , and . Note that Continuing in this way, for each let Again, we have that for each . Thus is a countable collection of disjoint measurable sets. Further for .  Fix , and take any . Let . Then, by the measurability of , where the second inequality comes from and the last inequality holds since . As this holds for all , the countable monotonicity of the outer measure gives It follows that is measurable.  We have thus shown that is a -algebra. It remains to complete the proof that is a measure when restricted to . It only remains to show that is countably additive on disjoint measurable sets. Let be a disjoint collection of measurable sets and let . If , then and so . Suppose now that . For every we have, by the measurability of and the finite additivity of on disjoint sets, As this holds for all , we have that . Hence . Thus is a measure space. That this measure space is complete is left as an exercise ( ).   "
},
{
  "id": "sec-construction-15",
  "level": "2",
  "url": "sec-construction.html#sec-construction-15",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Carathéodory measure "
},
{
  "id": "sec-construction-17",
  "level": "2",
  "url": "sec-construction.html#sec-construction-17",
  "type": "Definition",
  "number": "2.3.8",
  "title": "",
...
},
{
  ...
  "number": "2.3.9",
  "title": "",
  "body": "  Let be a non-empty set. Let be a non-empty collection of subseteq which is closed under relative complements relative complement . That is, if , then . Let be a premeasure, and let be the Carathéodory measure induced by . Then each is -measurable, and . That is, is the Carathéodory extension on .    Take . We will show that is -measurable, where is the outer measure induced by . Take any . We need to show that If then this equality clearly holds. Thus we will suppose that It suffices to show that Fix a . By the definition of , and since , there exists a countable collection such that and Note that, , and hence for each . Further, , and so for each . By the finite additivity of we thus have Thus As covers and covers we have that Thus As this holds for all , it follows that Thus is -measurable.  That for all follows since is countably monotone. Thus the Carathéodory measure induced by is an extension of .   "
},
{
  "id": "sec-construction-20",
  "level": "2",
  "url": "sec-construction.html#sec-construction-20",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "semirings of subsets "
},
{
  "id": "sec-construction-21",
  "level": "2",
  "url": "sec-construction.html#sec-construction-21",
  "type": "Definition",
  "number": "2.3.10",
  "title": "",
  "body": "   semiring of sets    Let be a non-empty set and let be a non-empty collection of subsets of . The collection is a semiring (of subsets of ) semiring if for each   ; and  there exists a finite disjoint collection of sets in such that      "
},
{
...
},
{
  ...
  "number": "2.3.13",
  "title": "",
  "body": "  Let be a semiring of subsets of a non-empty subset and let Then is closed under relative complements. Further, if is a premeasure on then extends uniquely to a premeasure on .    Note that is closed under finite intersections. It follows that is also closed under finite intersections. Now take . We can write as the disjoint union As each of the three terms can be written as disjoint unions of sets in , it follows that . Inductively, it can be shown that is closed under finite unions.  Let and be finite disjoint collections of sets from . We have that Thus, relative complements of sets in can be written as finite unions of finite intersections of sets in . As is closed under finite unions and finite intersections, it follows that is closed under relative complements.  Suppose now that is a premeasure on . For disjoint sets in define We must first show that is well-defined on . To this end, suppose and are finite disjoint collections in with . Note that, for each , is a disjoint union of sets in . By the finite additivity of , Similarly, for each , Thus, Hence is a well-defined function on .  That is finitely additive is clear. To show that is a premeasure, it remains to show countable monotonicity. To this end, take a countable collection in , and such that Note that, since is closed under finite unions and relative complements, we can assume that the collection is disjoint. As sets in are disjoint unions of sets in , can further assume that the sets are in . Let be disjoint sets in such that . By the countable monotonicity of we have for each . Hence Hence is a premeasure on .  The uniqueness of follows from the definition of .   "
},
{
  "id": "sec-construction-27",
  "level": "2",
  "url": "sec-construction.html#sec-construction-27",
  "type": "Remark",
  "number": "2.3.14",
  "title": "",
...
},
{
  ...
  "number": "2.3.15",
  "title": "",
  "body": "  Let be a set function on a collection of subsets of , and let be the induced outer measure, and let be the induced Carathéodory measure.  If satisfies then there exists an such that and . If is -measurable and each set in is -measurable, then is -measurable and .    Suppose . By the definition of , for each there exists a countable collection such that and Let . Then and Now let . Then , and . Further, for each , As this holds for all , it follows that .  Finally, if extends then every set in is measurable, and thus every set in and is measurable. If is also measurable, then by the excision property    "
},
{
  "id": "sec-construction-29",
  "level": "2",
  "url": "sec-construction.html#sec-construction-29",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "-finite "
...
},
{
  ...
  "number": "2.4.4",
  "title": "",
  "body": "  Let be a measurable space. Let be a measurable space. Fix , and let be the Dirac measure defined in . Show that is a measure.  Suppose is a topological space, and is the Borel sets. Show that is a Borel measure.   "
},
{
  ...
  "number": "2.4.5",
  "title": "",
  "body": "  Let be the extended real line. Let be the collection of sets in given by where is the collection of Borel sets in . Show that is a -algebra. Borel sets in the extended real line extended real line    "
},
{
...
},
{
  ...
  "number": "2.4.14",
  "title": "",
  "body": "  Show that the collection from forms a semiring. That is, if and are two measure spaces and show that is a semiring of subsets of . measurable rectangle    "
},
{
...
{
  "id": "prop-length-premeas",
  "level": "2",
  "url": "sec-Lebesgue.html#prop-length-premeas",
  "type": "Proposition",
  "number": "3.1.1",
  "title": "",
...
},
{
  "id": "sec-Lebesgue-6",
  "level": "2",
  "url": "sec-Lebesgue.html#sec-Lebesgue-6",
  "type": "Proof",
  "number": "3.1.1",
  "title": "",
...
},
{
  "id": "sec-Lebesgue-7",
  "level": "2",
  "url": "sec-Lebesgue.html#sec-Lebesgue-7",
  "type": "Definition",
  "number": "3.1.3",
  "title": "",
  "body": "   Lebesgue outer measure     Lebesgue measure    The function defined by is call the Lebesgue outer measure on . outer measure Lebesgue outer measure  The elements of the -algebra of -measurable sets are called Lebesgue measurable sets . measurable set Lebesgue measurable set  The Carathéodory measure got by restricting to is called the Lebesgue measure on . Lebesgue measure    "
...
},
{
  ...
  "number": "3.1.5",
  "title": "",
  "body": " says that all countable sets have Lebesgue measure . It does not say that if then is countable. We will see examples of uncountable sets of zero Lebesgue measure later.  "
},
{
...
},
{
  ...
  "number": "3.3.8",
  "title": "",
  "body": " When and , the measure constructed by is the Lebesgue measure.  "
},
{
  ...
  "number": "3.3.9",
  "title": "",
  "body": " Let be a closed interval in and let be a non-negative, increasing, right-continuous function on . If is not bounded below, further assume . Let be the Borel measure on satisfying constructed in .  If is a finite Borel measure then is the cumulative distribution function for .  "
},
{
  ...
  "number": "3.3.3",
  "title": "",
  "body": " Suppose is the minimal element of . Then, for each , the construction of in gives   Thus, is the cumulative distribution function for .  Now suppose is not bounded below and that Fix . Then   and hence is the cumulative distribution function for .  "
},
{
...
{
  "id": "prop-cont-measure",
  "level": "2",
  "url": "sec-borel-on-R.html#prop-cont-measure",
  "type": "Proposition",
  "number": "3.3.11",
  "title": "",
  "body": "  Let be a Borel measure on a closed interval , and let be the cumulative distribution of . Then for all if and only if is continuous and .    By , is right-continuous. Assume that is continuous and . Since , . Take any . Then by the (left) continuity of .  Conversely, suppose for all . Then . If then Hence is left-continuous, and therefore continuous, at .   "
},
{
  "id": "def-cont-meas",
  "level": "2",
  "url": "sec-borel-on-R.html#def-cont-meas",
  "type": "Definition",
  "number": "3.3.12",
  "title": "",
  "body": "  Let be a Borel measure on a closed interval . Then is a continuous Borel signed-measure if for all . measure continuous    "
},
{
  "id": "sec-borel-on-R-23",
  "level": "2",
  "url": "sec-borel-on-R.html#sec-borel-on-R-23",
  "type": "Definition",
  "number": "3.3.13",
  "title": "",
...
{
  "id": "def-cont-signed-meas",
  "level": "2",
  "url": "sec-signed-borel.html#def-cont-signed-meas",
  "type": "Definition",
  "number": "4.2.16",
  "title": "",
  "body": "  Let be a Borel signed measure on a closed interval . Then is a continuous Borel signed measure is for all . signed measure continuous    "
},
{
  "id": "prop-cont-signed-meas",
  "level": "2",
  "url": "sec-signed-borel.html#prop-cont-signed-meas",
  "type": "Proposition",
  "number": "4.2.17",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "chap-differentation-3.html#thm-Radon-Nikodym",
  "type": "Theorem",
  "number": "7.1.6",
...
},
{
  ...
  "number": "7.4.2",
  "title": "",
  "body": " Let be the Cantor-Lebesgue function on (see ), let be the Cantor set in and let By the definition of , there are disjoint open intervals such that such that is constant on each . It follows that for all . By , . Hence a.e., and so is a continuous singular function.  Recall that, by , if is the Borel measure on satisfying , then is a singular measure.  "
},
{
  "id": "prop-f-singular",
  "level": "2",
...
},
{
  ...
  "number": "7.4.6",
  "title": "",
  "body": " Let be a Borel measure on , with cumulative distribution function . If is continuous, then applying to gives the same decomposition as applying to .  If is not continuous, we can still apply to and decompose , where is absolutely continuous, and a.e. In this case will not be continuous.  "
},
{
...
},
{
  "id": "def-discrete",
  "level": "2",
  "url": "chap-differentation-6.html#def-discrete",
  "type": "Definition",
  "number": "7.4.10",
  "title": "",
...
{
  "id": "chap-differentation-6-19",
  "level": "2",
  "url": "chap-differentation-6.html#chap-differentation-6-19",
  "type": "Remark",
  "number": "7.4.11",
  "title": "",
  "body": " Note that, if is a discrete Borel signed measure, then the series is absolutely convergent.  Conversely, if is an absolutely convergent series, and is a countable collection of points in a closed interval , then is a discrete Borel signed measure on , ( ).  "
},
{
...
},
{
  ...
  "number": "7.5.3",
  "title": "",
  "body": "  Let be a -finite measure space and let be a -finite measure on with . Let be the Radon-Nikodym derivative of with respect to . Let be a measurable set, and let be a measurable function on which is integrable with respect to . Show that     First show the result holds for simple functions.   "
},
{
...
},
{
  ...
  "number": "7.5.5",
  "title": "",
  "body": " In it is shown that is a preorder.   Show that is not a partial order . I.e. show that is not antisymmetric. That is, show that we can have and but .   For -finite measures, show that if and then there is a scalar such that . That is, let be a measurable space and let and be non-zero -finite measures on such that and . Show that the Radon-Nikodym derivatives and are constant and (multiplicative) inverses of eachother. (HINT: Recall and ).    "
},
{
...
},
{
  ...
  "number": "7.5.7",
  "title": "",
  "body": " Complete the proof of . That is, if is a countable set, is a convergent series of positive numbers, and is the function on   then is continuous for all .  "
},
{
...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": " The field itself is a real vector space. The absolute value defines a norm on .  More generally, let . We can define a norm on by   for . This is called the Euclidean norm or the -norm on . norm Euclidean norm norm -norm on That is a norm is left as an exercise, .  "
},
{
  "id": "ex-C_b-X-norm",
  "level": "2",
...
},
{
  ...
  "number": "1.1.9",
  "title": "",
  "body": " The vector space with the -norm is a Banach space, see .  "
},
{
  "id": "ex-Cb-Banach",
  "level": "2",
  ...
  "number": "1.1.10",
  "title": "",
  "body": " Let be an interval. The normed vector space with norm (see ) is a Banach space, see  "
},
{
  "id": "ex-C0-Banach",
  "level": "2",
  ...
  "number": "1.1.11",
  "title": "",
  "body": " Let be an interval. A continuous function  vanishes at infinity vanishes at infinity if for all there is a closed interval such that for . We denote the collection of all continuous functions on that vanish at infinity by .  The space is a vector subspace of , thus is a normed vector space with the -norm . With this norm is a Banach space, see .  "
},
{
  "id": "ex-Cc-not-Banach",
  "level": "2",
...
},
{
  ...
  "number": "1.2.1",
  "title": "",
  "body": " First, assume that . Take and a scalar . Then   Hence .  Note that if , then Indeed,   and hence   Thus, if , then   Hence .  That is a vector space is left as an exercise, .  "
},
{
  "id": "rem-inf-norms",
  "level": "2",
  ...
  "number": "1.2.7",
  "title": "",
  "body": " Let be a Lebesgue measurable set and let be the Lebesgue measure on . We have the -norm on , and we have the -norm on . Note that any continuous function on is measurable with respect to Lebesgue measure , by . Thus, if then , and the -norm and the -norm of coincide. Thus the -norm is a restriction of an -norm to continuous bounded functions.  "
},
{
  "id": "rem-2-norms",
  "level": "2",
...
},
{
  ...
  "body": " Cauchy-Schwarz Inequality  Cauchy-Schwarz inequality Let be a measure space. If , then is integrable and   "
},
{
  "id": "cor-holder-cor",
  "level": "2",
...
},
{
  ...
  "number": "1.2.7",
  "title": "",
  "body": " The cases when and are covered in . For , Minkowski's inequality, , shows that satisfies the triangle inequality. That satisfies the other properties of a norm is straightforward.  "
},
{
...
},
{
  ...
  "number": "1.2.21",
  "title": "",
  "body": " Let be the Lebesgue measure on the interval . By , if , then . Let Then with   However since   More generally, if and   then but Also, note that is not bounded, and so Thus, if then   "
},
{
  "id": "ex-Lq-not-in-Lp",
  "level": "2",
  ...
  "number": "1.2.22",
  "title": "",
  "body": " Let be the Lebesgue measure on . Suppose . Let for , and for . Since is bounded, we have that . If , then, since , . However, since is not integrable on . Thus   Using the examples from we can also show that   Explicitly, for , if for and for , then but  "
},
{
  "id": "thm-lq-in-lp",
  "level": "2",
...
},
{
  ...
  "number": "1.3.3",
  "title": "",
  "body": " Let be a Lebesgue measurable set. We will show that we can approximate with a step function in the -norm. Fix . By the outer regularity of the Lebesgue measure, there is an open set such that Since is open, is a disjoint union of countably many open intervals . Choose , so that   and let . Then   and   Note that, since is a finite union of disjoint intervals, is a set function. By the above calculations we have   As simple functions are linear combinations of characteristic functions, it follows now that step functions are dense in the simple functions in . Hence, by , the step functions are dense in .  "
},
{
  "id": "lem-Lp-separable",
  "level": "2",
...
},
{
  ...
  "number": "1.3.4",
  "title": "",
  "body": " Take an arbitrary step function   where is a partition of , let . Choose rationals such that, for ,   and let and . Choose such that for ,   and let be the step function   Then   Hence  We have shown that the collection of all step functions taking rational values on partitions of with rational interior endpoints is dense in the collection of all step functions. It follows from , that is dense in . It is not hard to see that is countable, and hence is separable.  "
},
{
  "id": "thm-Lp-separable",
  "level": "2",
...
},
{
  ...
  "number": "1.3.5",
  "title": "",
  "body": " For a closed bounded interval , let be defined as in the proof of . That is, is all rational-valued step functions on defined using partitions of using rational values.  First assume that is bounded. Let be a closed bounded interval such that . Since is dense in the set of simple functions on , the set   is dense in the collection of simple functions on . Hence, is separable, by .  Assume now that is unbounded. For each , let . By the above argument, since is bounded, there is a countable set which is dense in Extend each to by setting for .  Take and fix By the continuity of integration, ,   Thus, we can choose such that   Since is dense in , there exists such that Thus   Thus . Hence, the countable set is dense in , and so is separable.  "
},
{
  "id": "thm-lp-separable",
  "level": "2",
...
},
{
  ...
  "number": "1.3.6",
  "title": "",
  "body": " If is finite, then , where is the cardinality of . Hence is separable.  If is countably infinite, then there is a bijection from to . This bijection defines an isometric isomorphism from to . We will thus assume that .  The simple functions in are the sequences which are finitely non-zero. Take simple and . For , choose such that   and let Then   and so Hence the finitely non-zero rational sequences are dense in the finitely non-zero sequences. As the finitely non-zero sequences are dense in by , it follows that the rational-valued simple functions are dense in . There are countably many finitely non-zero rational sequences, and hence is simple.  That is not separable when is uncountable is left as an exercise, . I recommend looking at the proof of before attempting .  "
},
{
...
},
{
  ...
  "number": "1.4.2",
  "title": "",
  "body": " Show that the -norm , defined in , defines a norm on . (HINT: Use for the triangle inequality).  "
},
{
...
},
{
  ...
  "number": "1.4.4",
  "title": "",
  "body": " Show that with the -norm is a Banach space. (Hint: Consider ).  "
},
{
  "id": "exer-Cb-Banach",
  "level": "2",
...
},
{
  ...
  "number": "1.4.8",
  "title": "",
  "body": " Prove : Let be a real vector space, and let and be two norms on . The norm is equivalent to if and only if the norm is equivalent to  "
},
{
...
},
{
  ...
  "number": "1.4.14",
  "title": "",
  "body": " Let be a measure space and take .   Show that  What can we conclude about ? (i.e. is in some -space?)    Use the polynomial  to prove the Cauchy-Schwarz inequality ( ). I.e., prove     Show that the map given by  defines an inner-product on such that for all .     "
},
{
...
},
{
  ...
  "number": "2.2.1",
  "title": "",
  "body": " The linearity of the map follows from the linearity of integration. Suppose and take By Hölder's inequality   for all Hence By , there is an with such that   and hence  "
},
{
...
},
{
  ...
  "number": "2.2.5",
  "title": "",
  "body": " shows that in order for the dual of to be (isometrically isomorphic to) , it is sufficient that be -finite. But is it necessary that is -finite? The proof relies on two key steps: first we show in , that if is -finite, then the map is a norm preserving map from to ; then in we show that the map is surjective.  You will notice, that the proof of does not fully rely on the fact that is -finite. Indeed, the property we use is that if , then there is a with . Measure spaces with this property are called semi-finite measure space semi-finite . Whilst all -finite measure spaces are semi-finite, not all semi-finite measure spaces are -finite. E.g., if is an uncountable set and is the counting measure on all the subsets of , then is semi-finite but not -finite.  The proof of surjectivity in also does not tell the whole story. In order for the map to be surjective, a necessary and sufficient condition is that the measure space is localizable . Other than to say that being localizable is a stronger condition than being semi-finite, but a weaker condition than being -finite, we will say no more on the topic. We refer the interested reader to the treatise of Fremlin .  In lieu of a more in-depth discussion on the dual of when is not -finite, we refer the reader to and . In , an example is given of a measure space which is not -finite, but the dual of is . In , an example is given where the dual of is not .  "
},
{
  "id": "ex-dual-of-linf",
  "level": "2",
...
},
{
  ...
  "number": "2.4.3",
  "title": "",
  "body": " Note that is a special case of . Indeed, if , and is the Dirac measure at , then   by .  "
},
{
  ...
  "number": "2.4.4",
  "title": "",
  "body": " Let be a finite Radon signed measure on a locally compact Hausdorff space . For each define by   Clearly is linear, by the linearity of integration. Note that,   where the last equality follows from . Thus, for ,   where the last inequality comes from . Hence , with  "
},
{
  "id": "sec-RMK-11",
  "level": "2",
...
},
{
  ...
  "number": "2.4.6",
  "title": "",
  "body": " Note that, if is a positive linear functional, then   That is, the norm of can be calculated using only non-negative functions, see  "
},
{
  "id": "sec-RMK-13",
  "level": "2",
  ...
  "number": "2.4.7",
  "title": "",
  "body": " The linear functionals described in (and ) are positive linear functionals. The linear functionals in are not necessarily positive.  "
},
{
...
},
{
  ...
  "number": "2.4.10",
  "title": "",
  "body": " You may have concerns with the use of the word the in the above definition. Uniqueness was never proved in . Rather than proving uniqueness directly (and justifying the terminology), we will leave this quibble for now. The Jordan decomposition of a linear functional is unique; the uniqueness will be addressed in .  "
},
{
  "id": "thm-RMK-positive",
  "level": "2",
...
},
{
  ...
  "number": "2.4.3",
  "title": "",
  "body": " Take . By , there are positive linear functionals and such that and . Both and restrict to positive linear functionals on . Thus, by , there are finite Radon measures and on such that, for ,   Further, and . As is dense in , we have   for all .  Let . Then . Let be the Jordan decomposition of . Then, , and so, by ,   for all . Rearranging the above equality, we get   for all . By ,   Since , by we also have , and so . Therefore .  We will now prove uniqueness. Suppose also satisfies for all . Let be the Jordan decomposition of . Then, for , two applications of give   By the uniqueness in , , and hence .  "
},
{
  "id": "cor-RMK-Banach",
  "level": "2",
...
},
{
  ...
  "number": "2.4.4",
  "title": "",
  "body": " Let be positive linear functionals on such that and . By , there is a finite Radon signed measure , and finite Radon measures and such that , , and ; and for all   Thus, for all ,   Hence, by the uniqueness of from , . We also have that   Therefore, by , is the Jordan decomposition of . That is and . As the Jordan decomposition of the signed measure is unique, by , it follows that and where is the Jordan decomposition of .  "
},
{
  "id": "sec-RMK-35",
  "level": "2",
  ...
  "number": "2.4.15",
  "title": "",
  "body": " The set of natural numbers with the discrete topology is a locally compact Hausdorff space. If is the collection of all sequences which converge to , then . By , the dual of is ; and by the dual of is , the space of all finite Radon signed measures on . Thus is isometrically isomorphic .  Explicitly, the maps between and are given as follows: for , the function on subsets of defined by   defines a finite Radon signed measure on . For , we can define a sequence . Then . These two operations are clearly inverses of eachother.  "
},
{
  ...
  "number": "2.4.16",
  "title": "",
  "body": " Again, consider the set of natural numbers with the discrete topology. There is a compact Hausdorff space containing as a dense subset such that   The space is called the Stone-\\u{C}ech compactification of . Note that . Thus, by ,   That is, the dual of is (isometrically isomorphic to) the Radon signed measures on the Stone-\\u{C}ech compactification of .  "
},
{
...
},
{
  ...
  "number": "2.5.1",
  "title": "",
  "body": " Prove . That is, show that the operator norm is a norm on the dual space , where is a normed vector space.  Further show that   for all  "
},
{
  ...
  "number": "2.5.2",
  "title": "",
  "body": " Prove for the case . That is, assuming that is a -finite measure space, show that if that there is a with such that   for all .  "
},
{
  "id": "exer-yes-dual",
  "level": "2",
  ...
  "number": "2.5.3",
  "title": "",
  "body": " Let be a non-empty set, and let be the counting measure on the -algebra of all subsets of . We will show that by the same isomorphism used in .   For each , let . Show that is a countable set, and that    Take . Define  for all . Show that is a linear functional on with . (You should be able to prove this directly without reference to the proof of ).    Take . For each , let be the function  Show that with , for all .  Define a function on by . Show that . Show that .     "
},
{
  "id": "exer-not-dual",
  "level": "2",
...
},
{
  ...
  "number": "2.5.7",
  "title": "",
  "body": "  Show that, if , then the map defined by  for all is a linear functional on .    Take any . For each , let , where is defined as in . Show that .   Take and let be as in part (ii). Show that for all .   Show that if , then there is an and a with such that     "
},
{
  "id": "exer-norm-on-bfa",
  "level": "2",
...
},
{
  ...
  "number": "2.5.11",
  "title": "",
  "body": " Prove . That is, show that is compact, if and only if whenever is a collection of closed sets satisfying for any , then   (HINT: Note that if and only if is an open cover of .)  "
},
{
...
{
  "id": "prop-lebesgue-invariant-Rn",
  "level": "2",
  "url": "sec-lebesgue-measure-on-Rn.html#prop-lebesgue-invariant-Rn",
  "type": "Proposition",
  "number": "1.2.7",
  "title": "",
...
},
{
  ...
  "number": "1.4.9",
  "title": "",
  "body": "  Let be the norm defined on , the matrices, defined in .     Show that defines a norm on       Show that if then     "
},
{
  ...
  "number": "1.4.10",
  "title": "",
  "body": " Let be the norm defined on , the matrices, defined in . For each , define the -norm on by identifying with . Show that is equivalent to for   "
},
{
  "id": "exer-borel-in-Rn",
  "level": "2",
...
},
{
  ...
  "body": "Locally compact groups  Recall that a group  is a non-empty set with an associative binary operation which has a (necessarily unique) identity and every element has an inverse. group We call the binary operation the group operation for . A group is called abelian  group abelian group if its binary operation is commutative.  For an arbitrary group , we will often call the group operation the product , and use concatenation to denote the product of two elements; and we will denote the inverse by That is, if then the product of and will be denoted by ; and the inverse of is . Notable exceptions to this rule are groups where the binary operation is usually called addition denoted by and inverses are denoted by , e.g. the group of real numbers with the operation of addition. For an arbitrary group , we will denote the identity element of by .    Let be a group. If there is a topology on the set such that the maps  product  and  inverse  ,   are continuous, is endowed with the product topology here then we is a topological group . group topological group   If is a topological group whose topology is locally compact and Hausdorff we call a locally compact Hausdorff group . group locally compact Hausdorff     Whilst the terminology may be new, you are probably familiar with several topological groups.   Let be any group. If we give the discrete topology, i.e. the topology in which every subset of is open, then is a locally compact Hausdorff space. A group endowed with the discrete topology is called a discrete group . group discrete group     The real line with the operation of addition is a locally compact Hausdorff group. More generally, is a locally compact Hausdorff group under addition. See .    More generally, if is a normed vector space, then (the operation of vector addition) is a Hausdorff topological group with the topology induced by the norm. Note that, in general, is not locally compact. In fact, is locally compact if and only if is finite dimensional.     The non-zero reals, are a topological group with the operation of multiplication.    Let Then , with the operation of multiplication, is a locally compact Hausdorff group.    The general linear group (of degree )  , is the set of all invertible matrices. general linear group The general linear group is a group with the operation of matrix multiplication. The general linear group is a subset of the finite dimensional vector space of all matrices. Endowing with its usual topology, induces a topology on which makes a locally compact Hausdorff group.  There are several ways we can describe the topology on . The easiest way is in terms of a norm. We can put a -norm on for by identifying with We can also put the operator norm on as described in . All these norms are equivalent, and so give the same topology on ; it doesn't matter what norm you use (see ). asks you to show is a topological group using the operator norm.   Let be a topological group, and let , and . We define the following pieces of notation: If , then we say that is symmetric . symmetric set    If is a topological group, then the map is continuous. This map is injective and surjective, and is its own inverse. That is, the map is a continuous bijection with a continuous inverse, i.e. a homeomorphism. In particular, this means that if is open\/closed\/compact, then is open\/closed\/compact, respectively.  Similarly, if we fix , then the map is a homeomorphism, as is the map . Thus these two maps also preserve open sets, closed sets, and compact sets.     Let be a topological group. Let be a neighborhood of the identity . Then  there is a symmetric neighborhood of the identity, such that ; and  there is a neighborhood of the identity, such that .  In particular, there is a symmetric neighborhood of the identity such that     For the first point, let .  Let denote the product map, By the continuity of , and since , is a neighborhood of in By the definition of the product topology, there is an open set , such that Thus, is an open neighborhood of the identity, satisfying   Finally, if we let , then is a symmetric neighborhood such that .      Let be a topological group, let , and let be a bounded real-valued function on . Define the left translation of by as the function and define the right translation of by as the function translation of a function by a group element   The function is left uniformly continuous if, for all there is a neighborhood of the identity such that for all continuous left uniformly continuous   The function is right uniformly continuous if, for all there is a neighborhood of the identity such that for all  continuous right uniformly continuous      The inverse in the definition of raise some eyebrows. Why introduce the inverse at all? There are two clear justifications for this. Firstly, our definitions of and preserve the group operations under composition. That is, for    The second point in favour of our notation, is that and on characteristic functions are consistent with left and right translations of sets. That is, if and then      Let be a locally compact group. Every function in is left and right uniformly continuous.    Fix , and let be the (necessarily compact) closure of the support of . Take . For each , let be the open set and let . Then, for each ,   By , there is a symmetric open open neighborhood of , such that . Since is compact, there are such that Let and fix   Take . There is a such that, . Since it follows that Note that and hence Thus,   Take . Then . If , then for some . Thus, since and (recall that each is symmetric). Hence, Thus, If , then and so,   We have shown that there is a neighborhood of , such that if and then Thus, for all , and hence is right uniformly continuous. That is left uniformly continuous can be shown similarly.    "
},
{
  "id": "def-top-group",
  "level": "2",
  ...
  "number": "2.1.1",
  "title": "",
  "body": "  Let be a group. If there is a topology on the set such that the maps  product  and  inverse  ,   are continuous, is endowed with the product topology here then we is a topological group . group topological group   If is a topological group whose topology is locally compact and Hausdorff we call a locally compact Hausdorff group . group locally compact Hausdorff    "
},
{
  ...
  "number": "2.1.2",
  "title": "",
  "body": " Let be any group. If we give the discrete topology, i.e. the topology in which every subset of is open, then is a locally compact Hausdorff space. A group endowed with the discrete topology is called a discrete group . group discrete group   "
},
{
  "id": "ex-R-top-group",
  "level": "2",
...
},
{
  ...
  "number": "2.1.4",
  "title": "",
  "body": " More generally, if is a normed vector space, then (the operation of vector addition) is a Hausdorff topological group with the topology induced by the norm. Note that, in general, is not locally compact. In fact, is locally compact if and only if is finite dimensional.   "
},
{
  ...
  "number": "2.1.5",
  "title": "",
  "body": " The non-zero reals, are a topological group with the operation of multiplication.  "
},
{
  "id": "ex-T-top-group",
  "level": "2",
  ...
  "number": "2.1.6",
  "title": "",
  "body": " Let Then , with the operation of multiplication, is a locally compact Hausdorff group.  "
},
{
  "id": "ex-GLn-top-group",
  "level": "2",
...
},
{
  ...
  "number": "2.1.8",
  "title": "",
  "body": " If is a topological group, then the map is continuous. This map is injective and surjective, and is its own inverse. That is, the map is a continuous bijection with a continuous inverse, i.e. a homeomorphism. In particular, this means that if is open\/closed\/compact, then is open\/closed\/compact, respectively.  Similarly, if we fix , then the map is a homeomorphism, as is the map . Thus these two maps also preserve open sets, closed sets, and compact sets.  "
},
{
  ...
  "number": "2.1.9",
  "title": "",
  "body": "  Let be a topological group. Let be a neighborhood of the identity . Then  there is a symmetric neighborhood of the identity, such that ; and  there is a neighborhood of the identity, such that .  In particular, there is a symmetric neighborhood of the identity such that     For the first point, let .  Let denote the product map, By the continuity of , and since , is a neighborhood of in By the definition of the product topology, there is an open set , such that Thus, is an open neighborhood of the identity, satisfying   Finally, if we let , then is a symmetric neighborhood such that .   "
},
{
...
},
{
  ...
  "number": "2.1.11",
  "title": "",
  "body": " The inverse in the definition of raise some eyebrows. Why introduce the inverse at all? There are two clear justifications for this. Firstly, our definitions of and preserve the group operations under composition. That is, for    The second point in favour of our notation, is that and on characteristic functions are consistent with left and right translations of sets. That is, if and then   "
},
{
...
},
{
  ...
  "number": "2.2.3",
  "title": "",
  "body": " The Lebesgue measure on the topological group is a Haar measure by .  "
},
{
  "id": "ex-R-prod-Haar",
  "level": "2",
  ...
  "number": "2.2.4",
  "title": "",
  "body": " Let be the group as in . Define a measure on the Borel sets in by for each Borel set , where is the Lebesgue measure. The measure is a Haar measure, see .  "
},
{
  "id": "ex-T-Haar",
  "level": "2",
...
},
{
  ...
  "number": "2.2.6",
  "title": "",
  "body": "  Recall the general linear group from . Identify the matrices with , and let be the Lebesgue measure on Define a measure on the Borel sets of by Note that if then defines an invertible linear map We can thus view as an matrix. One can show that . For small you can show this by hand, and perhaps use those calculations to construct a general argument. Alternatively, you can show that there is a symmetric orthogonal matrix such that , where is the identity matrix on . The result follows immediately from this. Thus, that is a left Haar measure follows from . That is a right Haar measure follows from the a similar argument, by considering multiplication on the right.   "
},
{
  ...
  "number": "2.2.7",
  "title": "",
  "body": "  Let be the semidirect product with product defined as for and . Then is a locally compact Hausdorff group (with the product topology on ). As a group, is isomorphic to the group of affine linear transformations on .  Define functions and on by and Define measures and on by for each Borel , where is the Lebesgue measure on (restricted to ).  Take any Borel and . Then, with the aide of Tonelli's Theorem and , we have where the third last equality apples (from ). Hence is a left Haar measure. However, is not a right Haar measure. Similarly, one can show that is a right Haar measure, but not a left Haar measure. Details are left to .   "
},
{
  ...
  "number": "2.2.8",
  "title": "",
  "body": "  Let be a locally compact Hausdorff group and let be a Radon measure on . Define a Radon measure by If is a left Haar measure, then is a right Haar measure; if is a right Haar measure, then is a left Haar measure.   "
},
{
  ...
  "number": "2.2.9",
  "title": "",
  "body": "  Let be a locally compact Hausdorff group. A functional on is left invariant if for all and . linear functional left invariant    "
},
{
  "id": "lem-haar-inv",
  "level": "2",
  ...
  "number": "2.2.10",
  "title": "",
  "body": "  Let be a locally compact Hausdorff group. Let be a Radon measure on and let be the positive linear functional on defined by for all The measure is a left Haar measure, if and only if is left invariant.    First assume that is a left Haar measure. Then, if is a Borel set, and , then By the linearity of integration , it follows that for all positive simple functions on . That is left invariant follows by the Simple Approximation Theorem and the Monotone Convergence Theorem .  Assume now that is left invariant. Fix open and take any compact subset . By Urysohn's Lemma , there is an such that , for and for . Take any . Then, By the inner regularity of open sets (since is a Radon measure) A similar argument shows that We have thus shown that for all and . It follows that for all and all Borel. Thus, is a left Haar measure.   "
},
{
  "id": "lem-haar-func-1",
  "level": "2",
  ...
  "number": "2.2.11",
  "title": "",
  "body": "  Let be a locally compact Hausdorff group and let be non-zero positive functions. Then there exists scalars and such that     Let be the compact support of , and let The set is a non-empty open set. Note that is an open cover of , and hence . Since is compact, there are such that is an open cover of . If , there exists and such that . Since, , it follows that If , then and so the inequality also holds there.   "
},
{
  "id": "lem-haar-func-2",
  "level": "2",
  ...
  "number": "2.2.12",
  "title": "",
  "body": "  Let be a locally compact Hausdorff group, be non-zero positive functions. Then   for all ;   for all scalars ;   ;   .  if , there exists an open neighborhood of the identity such that if the compact support of is in ;      Note that, for all  if and only if It follows that , and hence    and are (near) immediate, so we will turn our attention to . If there are positive scalars , and such that then Thus and so Similarly, and so , completing .  We will now prove Let be the compact support of , and let be a positive function such that for all Note that such a exists by Urysohn's Lemma . Take and let For , let . By  and are right uniformly continuous. Thus, there is an open neighborhood of the identity such that for all Thus, if then   Assume the the compact support of is in . Take scalars and such that Then, for , for  Note that, if , then , and hence , for Thus, Hence , for . Since, it follows that It follows now that where the last inequality is an application of and . By , the result follows if    "
},
{
  "id": "thm-Haar",
  "level": "2",
...
},
{
  ...
  "number": "2.3",
  "title": "Exercises",
  "body": "   Show that with the group operation of addition is a topological group.      Show that , as described in , is a topological group.    This can be shown directly. Alternatively, consider with the operation of addition, modulo . That is, is the group Show that is a topological group. Then show that there is a bijection such that is a homeomorphism and is a (group) isomorphism, to conclude that is a topological group.      Show that with the operation of multiplication is a topological group.      Show that the general linear group is a topological group with the topology induced by the norm define in .    You will need .      Let be the measure on defined in . Show that is a Haar measure on .    This can be done directly, by first proving the for intervals and extending the result to general Borel sets. Alternatively, it can be shown as an application of .      Let be the unit circle in as in . Let and let for Borel sets be as described in . We will show that is a Haar measure on .     Show that is a Borel measure on .      Show that is a Haar measure.       Let be the locally compact Hausdorff group from , and let and defined on in .     Show that is a right Haar measure.      Show that is not a right Haar measure.      Show that is not a left Haar measure.     "
},
{
  "id": "exer-R-top-group",
  "level": "2",
  ...
  "number": "2.3.1",
  "title": "",
  "body": "  Show that with the group operation of addition is a topological group.   "
},
{
  "id": "exer-T-top-group",
  "level": "2",
...
},
{
  ...
  "number": "2.3.3",
  "title": "",
  "body": "  Show that with the operation of multiplication is a topological group.   "
},
{
  ...
  "number": "2.3.4",
  "title": "",
  "body": "  Show that the general linear group is a topological group with the topology induced by the norm define in .    You will need .   "
},
{
  "id": "exer-R-prod-Haar",
  "level": "2",
  ...
  "number": "2.3.5",
  "title": "",
  "body": "  Let be the measure on defined in . Show that is a Haar measure on .    This can be done directly, by first proving the for intervals and extending the result to general Borel sets. Alternatively, it can be shown as an application of .   "
},
{
  "id": "exer-T-Haar",
  "level": "2",
  ...
  "number": "2.3.6",
  "title": "",
  "body": "  Let be the unit circle in as in . Let and let for Borel sets be as described in . We will show that is a Haar measure on .     Show that is a Borel measure on .      Show that is a Haar measure.    "
},
{
  ...
  "number": "2.3.7",
  "title": "",
  "body": "  Let be the locally compact Hausdorff group from , and let and defined on in .     Show that is a right Haar measure.      Show that is not a right Haar measure.      Show that is not a left Haar measure.    "
},
{
  "id": "sec-haus-meas",
  "level": "1",
  "url": "sec-haus-meas.html",
  "type": "Section",
  "number": "3.1",
...
},
{
  "id": "sec-haus-meas-3",
  "level": "2",
  "url": "sec-haus-meas.html#sec-haus-meas-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "diameter "
...
{
  "id": "prop-Hp-outer-meas",
  "level": "2",
  "url": "sec-haus-meas.html#prop-Hp-outer-meas",
  "type": "Proposition",
  "number": "3.1.1",
  "title": "",
